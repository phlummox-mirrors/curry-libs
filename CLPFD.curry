...
module CLPFD ( domain, inDomain
             , (+#), (-#), (*#), (/#)
             , (=#), (/=#), (<#), (<=#), (>#), (>=#)
             , abs, allDifferent, sum, labeling, genVars ) where
...
--- Specify domain for list of FD variables by the given integer list
--- @param vs  - list of FD variables
--- @param dom - integer domain for FD variables
inDomain :: [Int] -> [Int] -> Success
inDomain vs dom = (prim_inDomain $!! (ensureSpine vs)) $!! (ensureSpine dom)

prim_inDomain :: [Int] -> [Int] -> Success
...
--- Division of FD variables
--- @result - free variable to which the result of x/#y is bound
(/#) :: Int -> Int -> Int
x /# y = ((prim_FD_div $!! x) $!! y) result
 where result free

prim_FD_div :: Int -> Int -> Int -> Int
prim_FD_div external

--- Compute absolute value of FD variable
abs :: Int -> Int
...
--- satisfied if the FD variables in the argument list vs
